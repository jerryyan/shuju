...
class Search extends Controller
{
    public function index()
    {
        ...
        foreach ($swt as $k => $v) {
           ...
           $i array_filter($jinjia,function($v) use ($fwwz_utm){
                return stripos($v['pweb'], $fwwz_utm) !== false; 
            })

            // foreach ($jinjia as $c => $d) {
            //     if (stripos($d['pweb'], $fwwz_utm) !== false || stripos($d['mweb'], $fwwz_utm) !== false) {
            //         $data[$k]['zhanghu'] = $d['zhanghu'];
            //         $data[$k]['jihua'] = $d['jihua'];
            //         $data[$k]['dy'] = $d['dy'];
            //         $data[$k]['tfword'] = $d['keyword'];
            //         break;
            //     }
            // }
        }
