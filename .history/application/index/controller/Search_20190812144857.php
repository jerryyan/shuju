...
class Search extends Controller
{
    public function index()
    {
        ...
        foreach ($all_list as $k => $v) {
            ...
            $data[$k]['ddl'] = $this->getRound($v['afw'],  $v['aclick']);
            $data[$k]['yxzb'] = $this->getRound($v['ayd'], $v['adh']);
            $data[$k]['llv'] = $this->getRound($v['aliulian']'], $v['azx']);
            $data[$k]['djcb'] = $this->getRound($v['aclick'], $v['azx']);
            $data[$k]['dhcb'] = $this->getRound($v['aclick'], $v['azx']);
            $data[$k]['yxcb'] = $this->getRound($v['aclick'], $v['azx']);
            $data[$k]['llxb'] = $this->getRound($v['aclick'], $v['azx']);
        }
