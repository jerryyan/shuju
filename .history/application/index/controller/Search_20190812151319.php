...
class Search extends Controller
{
    ...
    {
        $a_sql = 'SELECT cigen,sum(click) as aclick,sum(zx) as azx,round(sum(zmxf),2) as azmxf,SUM(fanwwen) as afw,SUM(duihua) as adh,SUM(youxiao) as ayd,SUM(liulian) as aliulian FROM search_info  GROUP BY cigen';
        ...
        $w_sql = "SELECT cigen,ssword,sum(click) as aclick,sum(zx) as azx,round(sum(zmxf),2) as azmxf,SUM(fanwwen) as afw,SUM(duihua) as adh,SUM(youxiao) as yd,SUM(liulian) as aliulian FROM search_info  GROUP BY ssword";
