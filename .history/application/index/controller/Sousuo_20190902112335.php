...
class Sousuo extends Controller
{
    ...
    public function swtData()
    {
        ...
        $m_data = db::query("select *,a.keyword as ssword,b.keyword as tfword,left(stime,10) as swt_time from swt as a  LEFT  JOIN  jinjia as b ON a.utm=b.mutm where  fwwz like '%utm_source=' and left(stime,10)='{$timer}' GROUP BY a.id");
