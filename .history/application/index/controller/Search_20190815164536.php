...
class Search extends Controller
{
    ...
    public function exportCsv()
    {
        ...
        $list = db::query("select atime,stype,xiangmu,xiangmu,zhanghu,jihua,dy,tfword,ssword from search_info where atime >=? and atime <=?", [$start, $end]);
        foreach ($list as $v) {
            $rowData = [
                $v['atime'],
                $v['stype'],
        ...
        $this->toExcel($list, $title, $csvFileName,"php://output");
    }
