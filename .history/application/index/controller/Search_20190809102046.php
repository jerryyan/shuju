...
class Search extends Controller
{
    public function index()
    {
        ...
        $m——data = db::query("select * from swt as a  LEFT  JOIN  jinjia as b ON a.utm=b.mutm where  fwwz like '%utm_source=bdm%' GROUP BY a.id");
        $mutm = db::query("select * from swt as a  LEFT  JOIN  jinjia as b ON a.utm=b.mutm where  fwwz like '%utm_source=bdm%' GROUP BY a.id");
