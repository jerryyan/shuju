...
class Search extends Controller
{
    public function index()
    {
        ...
        $w_sql = "SELECT cigen,ssword,sum(click) as aclick,sum(zx) as azx,round(sum(zmxf),2) as azmxf,SUM(fanwwen) as afw,SUM(duihua) as adh,SUM(youxiao) as yx,SUM(liulian) as aliulian FROM search_info  GROUP BY ssword";
