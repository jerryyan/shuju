...
class Search extends Controller
{
    public function index()
    {
        ...
        SELECT cigen,ssword,sum(click) as aclick,sum(zx) as azx,round(sum(zmxf),2) as azmxf,SUM(fanwwen) as afw,SUM(duihua) as adh,SUM(youxiao) as yd,SUM(liulian) as aliulian FROM search_info  GROUP BY ssword
