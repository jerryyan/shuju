...
class Search extends Controller
{
    ...
    {
        $asql = 'SELECT cigen,sum(click) as aclick,sum(zx) as azx,round(sum(zmxf),2) as azmxf,SUM(fanwwen) as afw,SUM(duihua) as adh,SUM(youxiao) as ayd,SUM(liulian) as aliulian FROM search_info  GROUP BY cigen';
