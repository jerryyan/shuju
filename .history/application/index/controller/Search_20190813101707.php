...
class Search extends Controller
{
    ...
    public function export()
    {
        ...
        $j=2;
        foreach($list as $k=>$v){
            $objSheet->setCellValue('A'.$j,$v['real_name'])
            ->setCellValue('B'.$j,$v['real_name'])
            ->setCellValue('C'.$j,$v['real_name'])
            ->setCellValue('D'.$j,$v['real_name'])
            ->setCellValue('E'.$j,$v['real_name'])
            ->setCellValue('F'.$j,$v['real_name'])
            ...
            ->setCellValue(''.$j,$v['real_name'])
            ->setCellValue('A'.$j,$v['real_name'])
            ->setCellValue('A'.$j,$v['real_name'])
            ->setCellValue('A'.$j,$v['real_name'])
            ->setCellValue('A'.$j,$v['real_name'])
            ->setCellValue('A'.$j,$v['real_name'])
