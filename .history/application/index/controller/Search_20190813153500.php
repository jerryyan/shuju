...
class Search extends Controller
{
    public function index()
    {
        ...
        $a_sql = 'SELECT cigen,sum(click) as aclick,sum(zx) as azx,round(sum(zmxf),2) as azmxf,SUM(fanwwen) as afw,SUM(duihua) as adh,SUM(youxiao) as ayx,SUM(liulian) as aliulian FROM search_info where   GROUP BY cigen ORDER BY azmxf  DESC';
