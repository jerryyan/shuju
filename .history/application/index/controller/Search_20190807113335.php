...
class Search extends Controller
{
    ...
    public function getUtm($url)
    {
        if (stripos($url, 'utm_source')) {
            ...
            return $params['utm_source'] . '&' . $shuzi;
        } else {
            return '';
        }
    }

    unction get_between($input, $start, $end) {
    ...
    --------------------- 
    版权声明：本文为CSDN博主「qq琦」的原创文章，遵循CC 4.0 by-sa版权协议，转载请附上原文出处链接及本声明。
    原文链接：https://blog.csdn.net/u010265663/article/details/79195034/
